...
<style>
	...
	<!--button option-->
	<a href="1.1CustomerHome.php"> <div  class="box"><input name="back" type="Submit"  value= "Back">  </div></a>
	<a href="1.4BookingCust.php"> <div  class="box"><input name="next" type="Submit" value="next"></div></a>
